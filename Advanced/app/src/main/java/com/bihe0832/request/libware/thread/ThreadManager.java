package com.bihe0832.request.libware.thread;
...
public class ThreadManager {
    ...
    //后台线程、用户处理数据存储，业务逻辑等
    private final static String THREAD_NAME_BG = "BG";
    //网络请求线程，用于分发网络请求，网络请求的处理利用临时线程池
    private final static String THREAD_NAME_REQUEST = "REQUEST";
    //临时线程，用于通过handle处理一些临时逻辑、延迟逻辑
    private final static String THREAD_NAME_TEMP = "TEMP";
